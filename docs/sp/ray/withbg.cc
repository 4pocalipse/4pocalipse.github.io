...
namespace PC
{
    ...
    const unsigned ReflectionDepth = 5;
...
main()
{
    ...
    Material 	    Mirror(1.1, Vec4f(0.0, 10.0, 0.6, 0.0), Vec3f(1.0, 1.0, 1.0), 1425.f);
    
    std::vector<LightSource> LightSources = {
        LightSource(Vec3f(-185, 185, 185), Vec3f(1.0, 1.0, 1.0), 1),
        LightSource(Vec3f( 50,  0,   185), Vec3f(1.0, 1.0, 1.0), 1)
    };
    ...
    for (unsigned Frame = 1; Frame < 1000; Frame++) {
        ...
        std::vector<Sphere> Spheres = {
            ...
            Sphere(Vec3f( 7,  5,  Z[9]), 3, Mirror),
        };
        
        std::cout << "Rendering frame " << Frame << " ... (this can take a long time)\n";
